...
insert into videogame(id, title, description, release_date, pegi, player_num, adult_game, ingame_purchases,
                    price, platform_id, genre_id, software_house_id, game_dev_id, audio_dev_id,
                      graph_dev_id)
values (1, 'God of War Ragnarok', 'Le avventure di Kratos continuano al Nord', '2023-01-01', '16+', '1', 0, 0, 50, 3,
        1, 2, 4, 5, 6),
       (2, 'Hearthstone', 'Il gioco di carte con i protagonisti di World of Warcraft', '2018-01-01', '8+', '1', 0, 0,
        10, 2, 4, 1, 1, 2, 3),
       (3, 'GWENT', 'Il gioco di carte con i protagonisti di The Witcher 3', '2018-01-01', '8+', '1', 0, 0, 10, 2, 4,
        3, 7, 8, 9),
       (4, 'Zelda Breath of the wild', 'Scopri un mondo di avventure insieme a Link', '2018-01-01', '8+', '1', 0, 0,
        60, 4, 3, 3, 7, 8, 9);
